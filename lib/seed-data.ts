...
export const seedProducts: Product[] = [
  seedProduct({ slug: 'vip-box-blue', code: '1004488', title: 'VIP Box - Blue', category: 'vip', categoryTitle: 'VIP', price: 0, availableToday: false, description: 'Premium blue-toned VIP flower box placeholder for high-touch sales-assisted purchase testing.' }),
  ...
  seedProduct({ slug: 'imperium-vip-red-roses', code: '1001495', title: 'Imperium VIP - Red Roses', category: 'vip', categoryTitle: 'VIP', price: 0, availableToday: false, description: 'Statement red rose VIP arrangement placeholder for sales-assisted product tests.' }),
  seedProduct({ slug: 'imperium-vip-peach', code: '1001494', title: 'Imperium VIP - Peach', category: 'vip', categoryTitle: 'VIP', price: 0, availableToday: false, description: 'Peach-toned VIP arrangement placeholder for premium catalog coverage.' }),
  seedProduct({ slug: 'woshe-grand-cream', code: '1001471', title: 'Woshe Grand - Cream', category: 'vip', categoryTitle: 'VIP', price: 0, availableToday: false, description: 'Large cream-toned arrangement placeholder for premium product display tests.' }),
  ...
  seedProduct({ slug: 'vip-box-red-pink', code: '1001153', title: 'VIP Box - Red Pink', category: 'vip', categoryTitle: 'VIP', price: 0, availableToday: false, description: 'Red and pink VIP box placeholder for call-for-purchase product behavior.' }),
  seedProduct({ slug: 'imperium-pink', code: '1001148', title: 'Imperium - Pink', category: 'flower-boxes', categoryTitle: 'Flower Boxes', price: 0, availableToday: false, description: 'Pink imperium-style flower arrangement placeholder for premium listing tests.' }),
  seedProduct({ slug: 'teddy-bouquet', code: '1001139', title: 'Teddy Bouquet', category: 'birthday', categoryTitle: 'Birthday', price: 0, availableToday: false, description: 'Birthday teddy bouquet placeholder for celebration gift category tests.' }),
