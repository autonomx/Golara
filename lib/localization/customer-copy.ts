...
export const customerCopy: CustomerCopyRegistry = {
  ...
  fa: {
    ...
    'account.signInBody': 'با تایید شماره تلفن، به تاریخچه سفارش‌ها، نشانی‌های ذخیره‌شده و تکمیل سریع checkout دسترسی پیدا می‌کنید.',
    'account.signInWithPhone': 'ورود با شماره تلفن',
    'account.continueShopping': 'ادامه خرید',
    'account.savedAddresses': 'نشانی‌های ذخیره‌شده',
    'account.noSavedAddresses': 'هنوز نشانی ذخیره‌شده‌ای ندارید. هنگام checkout، نشانی ارسال به پروفایل شما اضافه می‌شود.',
    ...
    'cart.emptyBody': 'پیش از checkout، گل‌آرایی‌های موردنظر را به سبد خرید اضافه کنید.',
