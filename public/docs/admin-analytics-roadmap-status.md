...
11. Scheduled report preview, config, inactive table, Prisma mapping contract, checked schema fragment, read model, read-query contract, and read adapter preserve the selected range and aggregate CSV paths without enabling delivery.
