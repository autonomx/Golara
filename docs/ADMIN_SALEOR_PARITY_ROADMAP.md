...
- [x] Add consistent page headers, breadcrumbs, and primary actions.
...
- [x] Add product and variant attribute values.
...
- [x] Add fulfillment cards on order detail pages.
...
- [x] Add privacy/safety controls for sensitive fields.
...
- [x] Add email/SMS notification actions with retry state.
...
- [x] Add gift card or store-credit foundation if needed.
- [x] Add promotion audit logs.
...
- [x] Add locale-aware media alt text.
