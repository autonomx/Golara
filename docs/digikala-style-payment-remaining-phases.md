...
Start **Phase P9 — smoke-test checklist per method**. Keep it narrow: add a source-controlled checklist that maps each enabled method to production smoke evidence without changing runtime behavior.
