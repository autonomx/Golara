...
Use this register to track production launch or production-impacting security decisions that must be made before release. Keep completed records in the release tracker or deployment system unless repository storage is explicitly approved.
...
- **Deferred** — decision is outside this release scope.
