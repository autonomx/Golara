...
- keep provider-operation readiness route-core helpers, panels, pages, landing pages, and settlement navigation read-only and free of execution controls, click handlers, provider calls, direct Prisma access, and mutation paths;
