...
- keep provider-operation readiness route-core helpers, panels, and pages read-only and free of execution controls, click handlers, provider calls, direct Prisma access, and mutation paths;
...
2. Add admin navigation surfacing for the preview/history/provider-readiness pages only if it remains read-only and guarded.
