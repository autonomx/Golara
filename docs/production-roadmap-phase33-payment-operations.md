...
- keep provider-operation readiness route-core helpers, panels, pages, landing pages, settlement navigation, cross-links, and admin-navigation documentation read-only and free of execution controls, click handlers, provider calls, direct Prisma access, and mutation paths;
