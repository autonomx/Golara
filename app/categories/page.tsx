...
export default async function CategoriesPage() {
  ...
  return (
    <main id="main-content" tabIndex={-1} dir={getStorefrontCopyDirection(locale)}>
      <SiteHeader returnTo="/categories" />
      <section className="mx-auto max-w-7xl px-5 py-14">
        <p className="text-sm font-semibold uppercase tracking-[0.3em] text-olive">Collections</p>
        <h1 className="mt-3 font-display text-6xl text-rosewood">Browse all floral collections</h1>
        <p className="mt-4 max-w-2xl text-lg leading-8 text-stone-700">Choose a collection to view its products or continue into its subcategories when a collection has deeper catalog sections.</p>
