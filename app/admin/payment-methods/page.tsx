    ...
    >
      <div className="mx-auto grid w-full max-w-6xl gap-6">
        <div className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-stone-600">{t('Configure the DigiKala-style payment method stack independently from provider credentials. Methods can be enabled or disabled here; live online capture still depends on provider adapters and environment configuration.')}</p>
        </div>
