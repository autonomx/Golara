...
export function HomepageBannerSlideshow({ slides }: HomepageBannerSlideshowProps) {
  ...
  return (
    <section aria-label="Homepage banner slideshow" className="relative overflow-hidden bg-[#fff8f1]">
      <div className="relative min-h-[650px] w-full md:min-h-[720px]">
        ...
        <div className="absolute inset-y-0 left-0 flex w-full items-center px-5 pb-16 pt-24 md:px-20">
          <div className="max-w-2xl text-stone-800">
            <p className="inline-flex rounded-full border border-rosewood/10 bg-white/75 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-olive shadow-sm backdrop-blur">{activeSlide.eyebrow}</p>
            <h1 className="mt-6 max-w-3xl font-display text-5xl leading-[0.95] text-rosewood md:text-7xl">{activeSlide.title}</h1>
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <Link href="/products" className="inline-flex rounded-full border border-rosewood/20 bg-white/85 px-6 py-3 text-sm font-semibold text-rosewood shadow-sm transition hover:-translate-y-0.5 hover:border-rosewood focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-olive/30">
                All products
              </Link>
            ...
            <div className="mt-8 grid max-w-xl gap-3 text-sm font-medium text-stone-700 sm:grid-cols-3">
              <div className="flex items-center gap-2 rounded-2xl border border-rosewood/10 bg-white/70 px-4 py-3 shadow-sm backdrop-blur">
