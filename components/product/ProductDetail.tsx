...
const whatsAppLinkClass = 'rounded-full bg-rosewood px-6 py-3 text-sm font-semibold text-white outline-none transition focus-visible:ring-4 focus-visible:ring-olive/30';
