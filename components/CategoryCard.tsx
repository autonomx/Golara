...
export function CategoryCard({ category }: { category: Category }) {
  return (
    <Link href={`/categories/${category.slug}`} className="rounded-3xl border border-rosewood/10 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
