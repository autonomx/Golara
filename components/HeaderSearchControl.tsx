...
export function HeaderSearchControl({ label = 'Search products', placeholder = 'Search flowers...', submitLabel = 'Search', hideLabel = 'Hide product search' }: { label?: string; placeholder?: string; submitLabel?: string; hideLabel?: string } = {}) {
