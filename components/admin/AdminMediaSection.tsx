...
export function AdminMediaSection({
  ...
  return (
    <section id="media" className={panelClass}>
      ...
      <details className="rounded-lg border border-rosewood/10 bg-cream p-5">
        ...
        <div className="mt-5 grid gap-6 lg:grid-cols-2">
          <form action={createMediaFromUrlAction} className={formCardClass}>
            ...
            <Field label={t('Alt text')} name="alt" placeholder="Blush rose bouquet" disabled={disabled} />
      ...
      <MediaTable media={pagedMedia.items} categories={categories} products={products} disabled={disabled} columns={selectedMediaColumns} />
      <div className="mt-4">
