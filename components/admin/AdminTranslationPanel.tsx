...
function TranslationPublishedToggle({ translation }: { translation?: CompletenessTranslation }) {
  return (
  ...
  return (
    <form action={upsertHomepageTranslationAction} className="grid gap-3 rounded-3xl border border-rosewood/10 bg-cream p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-stone-500">Homepage hero · {locale}</p>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Translated eyebrow<input name="translationEyebrow" className={inputClass} defaultValue={translation?.eyebrow ?? ''} placeholder={homepage.eyebrow} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Translated title<input name="translationTitle" className={inputClass} defaultValue={translation?.title ?? ''} placeholder={homepage.title} required disabled={disabled} /></label>
      </div>
      <label className="grid gap-2 text-sm font-semibold text-rosewood">Translated body<textarea name="translationBody" className={textAreaClass} defaultValue={translation?.body ?? ''} placeholder={homepage.body} required disabled={disabled} /></label>
      <div className="grid gap-3 md:grid-cols-2">
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Primary CTA label<input name="translationPrimaryCtaLabel" className={inputClass} defaultValue={translation?.primaryCtaLabel ?? ''} placeholder={homepage.primaryCtaLabel} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Primary CTA URL<input name="translationPrimaryCtaHref" className={inputClass} defaultValue={translation?.primaryCtaHref ?? ''} placeholder={homepage.primaryCtaHref} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Secondary CTA label<input name="translationSecondaryCtaLabel" className={inputClass} defaultValue={translation?.secondaryCtaLabel ?? ''} placeholder={homepage.secondaryCtaLabel} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Secondary CTA URL<input name="translationSecondaryCtaHref" className={inputClass} defaultValue={translation?.secondaryCtaHref ?? ''} placeholder={homepage.secondaryCtaHref} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Panel eyebrow<input name="translationPanelEyebrow" className={inputClass} defaultValue={translation?.panelEyebrow ?? ''} placeholder={homepage.panelEyebrow} disabled={disabled} /></label>
        <label className="grid gap-2 text-sm font-semibold text-rosewood">Panel title<input name="translationPanelTitle" className={inputClass} defaultValue={translation?.panelTitle ?? ''} placeholder={homepage.panelTitle} disabled={disabled} /></label>
      </div>
      <label className="grid gap-2 text-sm font-semibold text-rosewood">Panel body<textarea name="translationPanelBody" className={textAreaClass} defaultValue={translation?.panelBody ?? ''} placeholder={homepage.panelBody} disabled={disabled} /></label>
      <div className="flex flex-wrap items-center gap-3"><TranslationPublishedToggle translation={translation} /><button className={buttonClass} type="submit" disabled={disabled}>Save homepage {locale}</button></div>
    </form>
  );
}
