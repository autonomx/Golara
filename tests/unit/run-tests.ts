...
import { runAdminPageShellAuthBoundaryTests } from './admin-page-shell-auth-boundary.test';
...
import { runInventoryStockReservationModelTests } from './inventory-stock-reservations-model.test';
...
import { runPaymentOperationHistoryRouteCoreTests } from './payment-operation-history-route-core.test';
...
import { runPaymentOperationPhase33CloseoutTests } from './payment-operation-phase33-closeout.test';
...
import { runPaymentOperationRecordRepositoryTests } from './payment-operation-record-repository.test';
...
async function main() {
  ...
  await runAdminPageShellAuthBoundaryTests();
  ...
  await runPaymentOperationPhase33CloseoutTests();
  await runPaymentOperationProviderReadinessTests();
  await runPaymentOperationProviderEvidencePacketTests();
  await runPaymentOperationTransitionPlanTests();
  await runPaymentOperationAdaptersTests();
  await runPaymentOperationRecordRepositoryTests();
