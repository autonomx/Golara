...
import { assertDatabaseOrPreviewFallback, canUseSeedFallback, getAppRuntimeMode, hasDatabase } from '../../lib/runtime-mode';
...
export async function runRuntimeModeTests() {
  ...
  await withEnv({ APP_MODE: 'preview', DATABASE_URL: undefined, VERCEL_ENV: undefined, NODE_ENV: 'production' }, () => {
  ...
  await withEnv({ APP_MODE: 'development', DATABASE_URL: 'postgresql://example.invalid/db', VERCEL_ENV: undefined, NODE_ENV: 'development' }, () => {
